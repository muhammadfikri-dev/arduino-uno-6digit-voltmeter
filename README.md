# ⚡ Arduino Uno 6.5-Digit Precision DC Voltmeter with Auto-Ranging
...
Laboratory digital voltmeter utilizing 24-bit ADS1256 ADC, low-noise LM399 voltage reference, reed-relay auto-ranging attenuator, and polynomial calibration.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-6digit-voltmeter.ino`](./arduino-uno-6digit-voltmeter.ino).
