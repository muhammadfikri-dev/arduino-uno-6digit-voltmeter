/**
 * =========================================================================================
 * Project     : Arduino Uno 6.5-Digit Precision DC Voltmeter with Auto-Ranging
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Laboratory digital voltmeter utilizing 24-bit ADS1256 ADC, low-noise LM399 voltage reference, reed-relay auto-ranging attenuator, and polynomial calibration.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno 6.5-Digit Precision DC Voltmeter with Auto-Ranging"));
